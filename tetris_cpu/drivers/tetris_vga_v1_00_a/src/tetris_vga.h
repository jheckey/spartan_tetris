/*****************************************************************************
* Filename:          /home/jheckey/Dropbox/homework/ece253/spartan_tetris/tetris_cpu/drivers/tetris_vga_v1_00_a/src/tetris_vga.h
* Version:           1.00.a
...
#define TETRIS_VGA_SLV_REG56_OFFSET (TETRIS_VGA_USER_SLV_SPACE_OFFSET + 0x000000E0)
#define TETRIS_VGA_SLV_REG57_OFFSET (TETRIS_VGA_USER_SLV_SPACE_OFFSET + 0x000000E4)

/**
 * Software Reset Space Register Offsets
 * -- RST : software reset register
 */
#define TETRIS_VGA_SOFT_RST_SPACE_OFFSET (0x00000100)
#define TETRIS_VGA_RST_REG_OFFSET (TETRIS_VGA_SOFT_RST_SPACE_OFFSET + 0x00000000)
...
#define TETRIS_VGA_mWriteSlaveReg56(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (TETRIS_VGA_SLV_REG56_OFFSET) + (RegOffset), (Xuint32)(Value))
#define TETRIS_VGA_mWriteSlaveReg57(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (TETRIS_VGA_SLV_REG57_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define TETRIS_VGA_mReadSlaveReg56(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (TETRIS_VGA_SLV_REG56_OFFSET) + (RegOffset))
#define TETRIS_VGA_mReadSlaveReg57(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (TETRIS_VGA_SLV_REG57_OFFSET) + (RegOffset))

/**
 *
 * Reset TETRIS_VGA via software.
 *
 * @param   BaseAddress is the base address of the TETRIS_VGA device.
 *
 * @return  None.
 ...
 * @note
 * C-style signature:
 * 	void TETRIS_VGA_mReset(Xuint32 BaseAddress)
 *
 */
#define TETRIS_VGA_mReset(BaseAddress) \
 	Xil_Out32((BaseAddress)+(TETRIS_VGA_RST_REG_OFFSET), SOFT_RESET)
