...
Peripheral Summary:
  ...
  logical library name                       : tetris_vga_v1_02_a
  top name                                   : tetris_vga
  version                                    : 1.02.a
  type                                       : PLB (v4.6) slave
...
- XST synthesis file(s)
  ...
  devl/synthesis/tetris_vga_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/tetris_vga_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/tetris_vga_v2_1_0.tcl
