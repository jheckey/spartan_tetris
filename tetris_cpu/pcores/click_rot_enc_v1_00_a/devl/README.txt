...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/jheckey/Dropbox/homework/ece253/spartan_tetris/tetris_cpu
  logical library name                       : click_rot_enc_v1_00_a
  top name                                   : click_rot_enc
  version                                    : 1.00.a
  type                                       : PLB (v4.6) slave
...
- ISE project file(s)
  ...
  devl/projnav/click_rot_enc.ise
...
- XST synthesis file(s)
  ...
  devl/synthesis/click_rot_enc_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/click_rot_enc_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/click_rot_enc_v2_1_0.tcl
...
plbv46_slave_single_v1_01_a
	/opt/Xilinx/14.3/ISE_DS/EDK/hw/XilinxProcessorIPLib/pcores/plbv46_slave_single_v1_01_a/doc/plbv46_slave_single.pdf

interrupt_control_v2_01_a
	/opt/Xilinx/14.3/ISE_DS/EDK/hw/XilinxProcessorIPLib/pcores/interrupt_control_v2_01_a/doc/interrupt_control.pdf
